...
#include "/home/hrcstudents/Documents/Code/catkin_ws/src/dmp_bbo_node/include/dmp_bbo_node/TaskSolverParallel.hpp"
...
public:
  ...
  virtual void performRollouts(const Eigen::MatrixXd& samples, Eigen::MatrixXd& cost_vars) const;

  //added performRollouts for the avoidance

  virtual void performRollouts(const Eigen::MatrixXd& samples, Eigen::MatrixXd& cost_vars, double avoidNum ) const;
  
  virtual void performRollouts(const std::vector<Eigen::MatrixXd>& samples_vec, Eigen::MatrixXd& cost_vars) const;

...
public:
  ...
  void updateDistributionMeanHrc(const Eigen::VectorXd& mean, const Eigen::MatrixXd& samples, const Eigen::VectorXd& costs, Eigen::VectorXd& weights, Eigen::VectorXd& mean_new) const;

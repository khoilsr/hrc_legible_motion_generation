...
#include "/home/hrcstudents/Documents/Code/catkin_ws/src/dmp_bbo_node/include/dmp_bbo_node/DynamicalSystem.hpp"
#include "/home/hrcstudents/Documents/Code/catkin_ws/src/dmp_bbo_node/include/dmp_bbo_node/Parameterizable.hpp"
...
public:
  ...
  void analyticalSolution(const Eigen::VectorXd& ts, Eigen::MatrixXd& xs, Eigen::MatrixXd& xds, Eigen::MatrixXd& forcing_terms, Eigen::MatrixXd& fa_output, double avoidNum) const;
   ...
   */
   ...
   // SARA --
   void analyticalSolution(const Eigen::VectorXd& ts, Eigen::MatrixXd& xs, Eigen::MatrixXd& xds, Eigen::MatrixXd& forcing_terms, Eigen::MatrixXd& obstacles, Eigen::MatrixXd& obstacles_forcing_term, Eigen::MatrixXd& fa_outputs) const;
   //void avoidObstacles(const Eigen::VectorXd& ts, Eigen::MatrixXd& xs, Eigen::MatrixXd& xds, Eigen::MatrixXd& obstacles, Eigen::MatrixXd& obstacles_forcing_term) const;
   void avoidObstacles(const Eigen::VectorXd& ts, const Eigen::MatrixXd& xs, const Eigen::MatrixXd& xds, Eigen::MatrixXd& obstacles, Eigen::MatrixXd& obstacles_forcing_term) const;
   void computeFunctionApproximatorInputsAndTargetsWithObstacles(const Trajectory& trajectory, Eigen::VectorXd& fa_inputs_phase, Eigen::MatrixXd& fa_targets, Eigen::MatrixXd& obstacles_forcing_term) const;
   void trainWithObstacles(const Trajectory& trajectory, std::string save_directory, Eigen::MatrixXd& obstacles, Eigen::MatrixXd& obstacles_forcing_term, bool overwrite=false);
  ...
  inline void analyticalSolution(const Eigen::VectorXd& ts, Eigen::MatrixXd& xs, Eigen::MatrixXd& xds, Eigen::MatrixXd& forcing_terms, double avoidNum) const
  {
    Eigen::MatrixXd fa_output;
    analyticalSolution(ts, xs, xds, forcing_terms, fa_output, avoidNum);
  }

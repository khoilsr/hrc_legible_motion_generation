...
template<typename Scalar, int RowsAtCompileTime, int ColsAtCompileTime>
bool saveMatrixHrc(std::string filename, Eigen::Matrix<Scalar,RowsAtCompileTime,ColsAtCompileTime> matrix, bool overwrite=false);
 ...
 */
template<typename Scalar, int RowsAtCompileTime, int ColsAtCompileTime>
bool saveMatrixHrc(std::string directory, std::string filename, Eigen::Matrix<Scalar,RowsAtCompileTime,ColsAtCompileTime> matrix, bool overwrite=false);
